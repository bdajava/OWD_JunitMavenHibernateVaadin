...
public class MyVaadinUI extends UI
{
    ...
    @VaadinServletConfiguration(productionMode = false, ui = MyVaadinUI.class, widgetset = "lv.polarisit.demosidemenu.AppWidgetSet")
...
//            b.setIcon(testIcon.get());
        ...
        if(label!=null)label.setValue(label.getValue() + " <span class=\"valo-menu-badge\">"
                + count + "</span>");
