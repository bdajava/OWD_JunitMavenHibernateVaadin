...
public class BatchInsertUpdate extends JPATest {
    ...
    public void batchInsertUpdate() throws Exception {
        ...
        tx.setTransactionTimeout(300); // 5 minutes
        ...
        try {
            ...
            long ONE_HUNDRED_THOUSAND = 10000; // Yes, we are lying here so the test doesn't run for 5 minutes
            {
                ...
                for (int i = 0; i < ONE_HUNDRED_THOUSAND; i++) {
                    ...
                    /* 
                       After 100 operations, flush and clear the persistence context. This will execute
                       ...
                       collection will free the memory.
                     */
                    if (i % 100 == 0) {
                        em.flush();
                        em.clear();
            ...
            }
            {
                ...
                /* 
                   ...
                   database. But instead of retrieving the result of the query completely
