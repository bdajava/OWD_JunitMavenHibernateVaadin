    ...
    public void cacheNaturalId() throws Exception {
        ...
        try {
            ...
            { // Execute the lookup again, hit the cache
                ...
                /* 
                   The natural identifier cache region of <code>User</code>
                   has one element.
                 */
                NaturalIdCacheStatistics userIdStats =
                    stats.getNaturalIdCacheStatistics(User.class.getName() + "##NaturalId");
        ...
        try {
...

            {
                ...
                /* 
                   ...
                   second-level cache won't be used at all.
                 */
                ...
                /* 
                   With the statistics API you can find out more details. This
                   is the first time this query is executed, so you get a cache
                   miss and not a hit. Hibernate put the query and its result
                   into the cache. If you run the exact same query again, the
                   result will be retrieved from the cache.
                 */
