...
public class TransactionManagerSetup {
    ...
    public TransactionManagerSetup(DatabaseProduct databaseProduct,
        ...
        logger.info("TransactionManagerSetup() DB:" + databaseProduct+" url:"+ connectionURL);
        //connectionURL = "jdbc:h2:tcp://localhost/~/Java/h2db/test1";

        //logger.info("TransactionManagerSetup() connectionURL: : " + connectionURL);
        //databaseProduct.
