...
public enum DatabaseProduct {
    ...
    H2(
        ...
        new DataSourceConfiguration() {
            ...
            public void configure(PoolingDataSource ds, String connectionURL) {
                ...
                Logger.getLogger(DatabaseProduct.class.getName()).info("DatabaseProduct() H2 - configure() db url:"+connectionURL);
 ...
 //                       "jdbc:h2:mem:test"
                ...
                System.setProperty("keepSchema", "true"); // force keep schema!
            }
        },
